<div>
    <div class="bg-gray-900 pb-10 pt-2 px-4 md:px-20 lg:px-20 xl:px-20">
        <div class="flex">
            ...
            <div class="relative w-full">
                ...
                @csrf
                    <input type="search" id="search" name="search" class="block p-4 w-full z-20 text-sm text-gray-900 bg-gray-900 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Busca el repuesto que necesitas..." required autocomplete="off">
                    {{-- <button class="absolute top-0 right-0 p-4 text-sm font-medium text-zinc-200 bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-700 dark:hover:bg-blue-600 dark:focus:ring-blue-600" type="submit" id="search" name="search"><svg aria-hidden="true" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg> --}}
                </form>
            </div>
            </button>
        </div>
