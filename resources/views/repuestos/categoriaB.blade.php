...
@else
    <div class="bg-white grid grid-cols-2 p-6 mx-8 md:mx-32 lg:mx-60 my-16 rounded-lg">
        ...
        <div class="col-span-2 md:col-span-1">
            <ul>
                <li class="text-gray-900 text-sm my-2">-Revisá la ortografía de la palabra.</li>
                <li class="text-gray-900 text-sm mb-2">-Utilizá palabras más genéricas o menos palabras.</li>
